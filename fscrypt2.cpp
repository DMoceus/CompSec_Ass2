...
void* fs_encrypt(void* plaintext, int bufsize, char* keystr, int *resultlen){
	...
	//BF_cbc_encrypt((const unsigned char*)0x1010101010101010, output, BLOCKSIZE+1, key, iv, BF_ENCRYPT);
	return (void*)output;
}
...
void* fs_decrypt(void* ciphertext, int bufsize, char* keystr, int* resultlen){
	...
	//BF_cbc_encrypt((const unsigned char*)0x1010101010101010, output, BLOCKSIZE+1, key, iv, BF_DECRYPT);
	return (void*)output;
}
/*
